...
function PageSlider(container) {
    ...
    this.slidePageFrom = function(page, from) {
        ...
        var c;
        if (from.indexOf('half') == -1)
        	c = (from === "page-left" ? "page-right" : "page-left")
        else
        	c = (from === "page-left-half" ? "page-right-half" : "page-left-half")
        
        currentPage.attr("class", "page transition " + c);
        currentPage = page;
    }
}